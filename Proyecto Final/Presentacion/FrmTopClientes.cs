...
namespace Presentacion
{
    public partial class FrmTopClientes : Form
    {
        ...
        private void GrafCategorias()
        {
            ...
            while (dr.Read())
            {
                NombreCliente.Add(dr.GetString(0));  // Nombre del producto en el índice 0
            ...
            newSeries.Points.DataBindXY(NombreCliente, CantidadVendida);
        ...
        private void btnDia_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("TopClientesDia", Conexion);
            cmd.CommandType = CommandType.StoredProcedure;
            Conexion.Open();
            dr = cmd.ExecuteReader();
            ...
            this.lblTopClientes.Text = "TOP CLIENTES DEL DÍA:";
        }
        ...
        private void btnMes_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("TopClientesMes", Conexion);
            cmd.CommandType = CommandType.StoredProcedure;
            Conexion.Open();
            dr = cmd.ExecuteReader();
            ...
            this.btnAnio.BackColor = Color.FromArgb(217, 127, 48);
            this.lblTopClientes.Text = "TOP CLIENTES DEL MES:";
        }
        ...
        private void btnAnio_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("TopClientesAno", Conexion);
            cmd.CommandType = CommandType.StoredProcedure;
            Conexion.Open();
            dr = cmd.ExecuteReader();
            ...
            this.lblTopClientes.Text = "TOP CLIENTES DEL AÑO:";
        }
        ...
        private void ObtenerProductosVendidosPorRangoDeFechas()
        {
            ...
            cmd = new SqlCommand("TopClientesEntreFechas", Conexion);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            this.lblTopClientes.Text = "TOP CLIENTES ENTRE EL " + fechaInicioTexto.ToUpper() + " Y " + fechaFinalTexto.ToUpper() + ":";
        }
